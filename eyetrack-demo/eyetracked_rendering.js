let cameras = [
  ...
  async function main() {
    ...
    webgazer.setGazeListener(function (data, elapsedTime) {
      ...
      var lefteye = data.eyeFeatures.left;
      var righteye = data.eyeFeatures.right;
      var midx = (lefteye.imagex + righteye.imagex) / 2;
      var midy = (lefteye.imagey + righteye.imagey) / 2;
      var eyewidth = (lefteye.width + righteye.width) / 2;
      // console.log(elapsedTime); //elapsed time is based on time since begin was called
      // console.log('Left Eye:', lefteye);
      // console.log('Right Eye:', righteye);
      // console.log('Middle of Eyes:', midx, midy);

      let inv = invert4(defaultViewMatrix);
      const xy_scalar = 3e-3; 
      // const z_scalr = 1e-1;
      const z_scalr = 0;
      inv = translate4(inv, (-xy_scalar * (midx - 255)), (xy_scalar * (midy - 255)), (z_scalr * (eyewidth - 25)));
      viewMatrix = invert4(inv);
    }, 15).begin(); // Set frequency to every 15ms
